...
module tb_alu_imm;
    ...
    initial begin
        // CASE 1: addi R7, R4, -9
        // (Op=0, Ra=7, Rb=4, C=-9) -> Hex: 03A7FFF7 (-9 is 19-bit 2's complement 7FFF7)
        DUT.ram_inst.memory[ 9'h000 ] = 32'h03A7FFF7; 
        
        // CASE 2: andi R7, R4, 0x71
        // (Op=0, Ra=7, Rb=4, C=0x71) -> Hex: 03A00071
        DUT.ram_inst.memory[ 9'h001 ] = 32'h03A00071; 
        
        // CASE 3: ori R7, R4, 0x71
        // (Op=0, Ra=7, Rb=4, C=0x71) -> Hex: 03A00071
        DUT.ram_inst.memory[ 9'h002 ] = 32'h03A00071; 
    end
    ...
    initial begin
        ...
        // FORCE the value directly into the hardware register to test the ALU
        force DUT.R4.Q = 32'h0000_0015; // 0x15 = 21 in decimal
    ...
    parameter Default = 5'd0, 
              T0_1=5'd1, T1_1=5'd2, T2_1=5'd3, T3_1=5'd4, T4_1=5'd5, T5_1=5'd6,
              T0_2=5'd7, T1_2=5'd8, T2_2=5'd9, T3_2=5'd10, T4_2=5'd11, T5_2=5'd12,
              T0_3=5'd13, T1_3=5'd14, T2_3=5'd15, T3_3=5'd16, T4_3=5'd17, T5_3=5'd18;
    ...
    always @(posedge clk) begin
        if (clr) Present_state <= Default;
            ...
            case (Present_state)
                ...
                T3_1: Present_state <= T4_1; T4_1: Present_state <= T5_1; T5_1: Present_state <= T0_2;

                T0_2: Present_state <= T1_2; T1_2: Present_state <= T2_2; T2_2: Present_state <= T3_2;
                T3_2: Present_state <= T4_2; T4_2: Present_state <= T5_2; T5_2: Present_state <= T0_3;
                
                T0_3: Present_state <= T1_3; T1_3: Present_state <= T2_3; T2_3: Present_state <= T3_3;
                T3_3: Present_state <= T4_3; T4_3: Present_state <= T5_3; T5_3: Present_state <= T5_3; 
            endcase
        end
    end
    ...
    always @(Present_state) begin
        ...
        case (Present_state)
            ...
            T3_1: begin Grb = 1; Rout = 1; Yin = 1; end
            T4_1: begin Cout = 1; ADD_op = 1; Zin = 1; end
            T5_1: begin Zlowout = 1; Gra = 1; Rin = 1; end
            ...
            T3_2: begin Grb = 1; Rout = 1; Yin = 1; end
            T4_2: begin Cout = 1; AND_op = 1; Zin = 1; end
            T5_2: begin Zlowout = 1; Gra = 1; Rin = 1; end
            ...
            T3_3: begin Grb = 1; Rout = 1; Yin = 1; end
            T4_3: begin Cout = 1; OR_op = 1; Zin = 1; end
            T5_3: begin Zlowout = 1; Gra = 1; Rin = 1; end
        endcase
    end
endmodule