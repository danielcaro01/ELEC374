...
module tb_not;
    ...
    initial begin
        // not R4, R7
        // I-Format: Opcode (31..27) = 10101, Ra (26..23) = 0100, Rb (22..19) = 0111, Unused = 0 [1]
        // Binary: 1010_1010_0011_1000_0000_0000_0000_0000 -> Hex: AA380000
        DUT.ram_inst.memory[ 9'h000 ] = 32'hAA380000; 
    end
    ...
    initial begin
        ...
        // Preload R7 with a recognizable hex pattern to test the bitwise inversion
        force DUT.R7.Q = 32'h1234_5678; 
        #10; 
        release DUT.R7.Q;
    end
    ...
    // --------------------------------------------------------
    initial begin $dumpfile("tb_not.vcd"); $dumpvars; end
    ...
    always @(Present_state) begin
        ...
        case (Present_state)
            ...
            // The `not` instruction does not use the Y register [2]. 
            // It strictly extracts Rb onto the Bus and routes it straight through the ALU to Z.
            T3: begin Grb = 1; Rout = 1; NOT_op = 1; Zin = 1; end 
