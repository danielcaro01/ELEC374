...
module tb_mul;
    ...
    always @(*) begin
        ...
        case (Present_state)
            Default: clr = 1;
            Reg_load1a: begin Mdatain=32'hFFFFFFFE; Read=1; MDRin=1; end
            Reg_load1b: begin BusMuxSel=5'd21; R3in=1; end
            Reg_load2a: begin Mdatain=32'h04; Read=1; MDRin=1; end
            ...
            T4: begin BusMuxSel=5'd1; MUL_op=1; Zin=1; end
            T5: begin BusMuxSel=5'd19; LOin=1; end
            T6: begin BusMuxSel=5'd18; HIin=1; end
        endcase
    end
endmodule