...
module tb_add;
    ...
    DataPath DUT ( /* Assumes you map all defined signals into your Datapath instance */ );
    ...
    always @(*) begin
        ...
        case (Present_state)
            Default: clr = 1;
            Reg_load1a: begin Mdatain=32'h22; Read=1; MDRin=1; end
            Reg_load1b: begin BusMuxSel=5'd21; R5in=1; end
            Reg_load2a: begin Mdatain=32'h33; Read=1; MDRin=1; end
            ...
            T4: begin BusMuxSel=5'd6; ADD_op=1; Zin=1; end
