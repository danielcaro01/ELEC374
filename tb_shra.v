...
`timescale 1ns/10ps
module tb_shra;
    // ... Same basic logic, but loads a negative to test signed propagation
    ...
    always @(*) begin
        ...
        case (Present_state)
            Default: clr = 1;
            Reg_load1a: begin Mdatain=32'h80000010; Read=1; MDRin=1; end
            ...
            T4: begin BusMuxSel=5'd4; SHRA_op=1; Zin=1; end
